...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "coaches" ADD CONSTRAINT "coaches_college_id_colleges_id_fk" FOREIGN KEY ("college_id") REFERENCES "public"."colleges"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "prospects" ADD CONSTRAINT "prospects_coach_id_coaches_id_fk" FOREIGN KEY ("coach_id") REFERENCES "public"."coaches"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "prospects" ADD CONSTRAINT "prospects_linked_player_id_players_id_fk" FOREIGN KEY ("linked_player_id") REFERENCES "public"."players"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "prospects_rels" ADD CONSTRAINT "prospects_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."prospects"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "prospects_rels" ADD CONSTRAINT "prospects_rels_tournaments_fk" FOREIGN KEY ("tournaments_id") REFERENCES "public"."tournaments"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "coaches_college_idx" ON "coaches" USING btree ("college_id");
  ...
  CREATE INDEX "prospects_coach_idx" ON "prospects" USING btree ("coach_id");
  CREATE INDEX "prospects_linked_player_idx" ON "prospects" USING btree ("linked_player_id");
  ...
  CREATE INDEX "prospects_rels_order_idx" ON "prospects_rels" USING btree ("order");
  CREATE INDEX "prospects_rels_parent_idx" ON "prospects_rels" USING btree ("parent_id");
  CREATE INDEX "prospects_rels_path_idx" ON "prospects_rels" USING btree ("path");
  CREATE INDEX "prospects_rels_tournaments_id_idx" ON "prospects_rels" USING btree ("tournaments_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "prospects_rels" CASCADE;
